...
const steps = [
  { id: 1, title: "Anlagenart", description: "EEG-Anlage und technische Daten" },
  { id: 2, title: "Betreiber", description: "Anlagenbetreiber und Installateur" },
  { id: 3, title: "Standort", description: "Anlagenstandort und Netzanschluss" },
  { id: 4, title: "Abschluss", description: "Bankdaten und Bestätigungen" },
];
...
const NeueAnlage: React.FC = () => {
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1:
        return formData.step1.eegAnlage && formData.step1.eegKategorie && formData.step1.gesamtleistung;
      case 2:
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <Label htmlFor="eegAnlage">EEG-Anlage *</Label>
                      <Select value={formData.step1.eegAnlage} onValueChange={(value) => setStep1({ eegAnlage: value })}>
                        <SelectTrigger>
                          <SelectValue placeholder="EEG-Anlage auswählen" />
                        </SelectTrigger>
                        <SelectContent>
                          {EEG_ANLAGEN_OPTIONEN.map((option) => (
                    ...
                    <div>
                      <Label htmlFor="eegKategorie">EEG-Kategorie *</Label>
                      <Select value={formData.step1.eegKategorie} onValueChange={(value) => setStep1({ eegKategorie: value })}>
                        <SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <Label htmlFor="gesamtleistung">Gesamtleistung (kWp) *</Label>
                      <Input
                        id="gesamtleistung"
                        type="number"
                        step="0.01"
                        value={formData.step1.gesamtleistung}
                        onChange={(e) => setStep1({ gesamtleistung: e.target.value })}
